...
export default function CareerLandingPage({ posts }) {
  ...
  const titlesection="Ejecutivo Municipal"
  const actualizacioninfo= "Presentamos a las autoridades"
  ...
  return (
    <Page title="Ejecutivo Municipal">
     <InstituciónSectionOne titlesection={titlesection} actualizacioninfo={actualizacioninfo} />
